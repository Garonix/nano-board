  ...
  return (
    <div
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-neutral-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          点击插入
        </div>
      </div>
    </div>
...
export const HistorySidebar: React.FC<HistorySidebarProps> = ({
  ...
  return (
    <div
      ref={sidebarRef}
      className="fixed top-0 right-0 h-full w-full sm:w-96 md:w-96 lg:w-96 bg-surface-elevated shadow-xl z-50 flex flex-col animate-slide-in-right border-l border-border backdrop-blur-sm mobile-sidebar tablet-sidebar"
    >
      {/* 现代化头部 */}
